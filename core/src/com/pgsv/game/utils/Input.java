...
public class Input {
    ...
    public static Vector2 calculateMouse(){
        return new Vector2((Gdx.input.getX() / (float)Gdx.graphics.getWidth()) * com.pgsv.game.utils.C.WIDTH,
                ((Gdx.graphics.getHeight() - Gdx.input.getY()) /
                        (float) Gdx.graphics.getHeight()) * com.pgsv.game.utils.C.HEIGHT );
    }
